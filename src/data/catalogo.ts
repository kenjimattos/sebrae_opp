...
export const catalogo: Catalogo = {
  ...
  baseEconomica: [
    { id: 'idsc', label: 'IDSC — Índice Brasileiro de Conectividade', icone: 'bar-chart' },
    ...
    { id: 'meis', label: 'MEIs (2025)', icone: 'building' },
    { id: 'mes', label: 'MEs (2025)', icone: 'building' },
    { id: 'epps', label: 'EPPs (2025)', icone: 'building' },
  ],
}
