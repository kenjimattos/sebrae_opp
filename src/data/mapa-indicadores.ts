...
export const indicadorOptions = [
  // Governança
  { label: 'Índice CFA de Governança Municipal', shortLabel: 'Governança Municipal', value: 'governanca_cfa' },
  { label: 'IDH-M', shortLabel: 'IDH-M', value: 'idhm' },
  { label: 'ISDEL', shortLabel: 'ISDEL', value: 'isdel' },
  // Simplificação
  { label: 'Tempo médio de abertura de empresa', shortLabel: 'Abertura de empresa', value: 'tempo_abertura' },
  { label: 'Tempo médio de viabilidade de empresa', shortLabel: 'Viabilidade de empresa', value: 'tempo_viabilidade' },
  { label: 'Ranking Redesim', shortLabel: 'Ranking Redesim', value: 'ranking_redesim' },
  ...
  { label: 'Educação Empreendedora - ISDEL', shortLabel: 'Educação Empreendedora', value: 'educacao_isdel' },
  { label: 'Trabalhadores formais com Ensino Médio Completo', shortLabel: 'Ensino Médio', value: 'ensino_medio' },
  { label: 'Trabalhadores formais com Ensino Superior Completo', shortLabel: 'Ensino Superior', value: 'ensino_superior' },
  // Viabilização financeira
  { label: 'Taxa de crescimento do valor das Operações de Crédito', shortLabel: 'Operações de Crédito', value: 'operacoes_credito' },
  { label: 'Taxa de crescimento do valor dos Financiamentos - BACEN', shortLabel: 'Financiamentos', value: 'financiamentos' },
  // Inclusão produtiva
...
export const municipiosMapData: Record<string, MunicipioMapData> = {
  '2507507': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '3%', valorNumerico: 3, status: 'success' },
      financiamentos: { valor: '5%', valorNumerico: 5, status: 'success' },
  ...
  '2504009': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '-5%', valorNumerico: -5, status: 'alert' },
      financiamentos: { valor: '1%', valorNumerico: 1, status: 'warning' },
  ...
  '2510808': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '-8%', valorNumerico: -8, status: 'alert' },
      financiamentos: { valor: '-2%', valorNumerico: -2, status: 'alert' },
  ...
  '2501302': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '-3%', valorNumerico: -3, status: 'alert' },
      financiamentos: { valor: '0%', valorNumerico: 0, status: 'warning' },
  ...
  '2513505': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '-6%', valorNumerico: -6, status: 'alert' },
      financiamentos: { valor: '-1%', valorNumerico: -1, status: 'alert' },
  ...
  '2503209': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '4%', valorNumerico: 4, status: 'success' },
      financiamentos: { valor: '6%', valorNumerico: 6, status: 'success' },
  ...
  '2506301': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '-2%', valorNumerico: -2, status: 'warning' },
      financiamentos: { valor: '2%', valorNumerico: 2, status: 'warning' },
  ...
  '2514602': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '-4%', valorNumerico: -4, status: 'alert' },
      financiamentos: { valor: '-1%', valorNumerico: -1, status: 'alert' },
  ...
  '2508307': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '-7%', valorNumerico: -7, status: 'alert' },
      financiamentos: { valor: '-3%', valorNumerico: -3, status: 'alert' },
  ...
  '2505600': {
    ...
    indicadores: {
      ...
      operacoes_credito: { valor: '-9%', valorNumerico: -9, status: 'alert' },
      financiamentos: { valor: '-4%', valorNumerico: -4, status: 'alert' },
