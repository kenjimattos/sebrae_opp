...
export const municipiosMapData: Record<string, MunicipioMapData> = {
  ...
  '2510808': {
    ...
    indicadores: {
      ...
      igma: { valor: '0,38', valorNumerico: 0.38, status: 'alert' },
      ...
      mpe_eli_sebrae: { valor: '-2%', valorNumerico: -2, status: 'alert' },
      compras_publicas_inovacao: { valor: '+1%', valorNumerico: 1, status: 'alert' },
      educacao_isdel: { valor: '0,28', valorNumerico: 0.28, status: 'alert' },
      ensino_medio: { valor: '65%', valorNumerico: 65, status: 'warning' },
      ensino_superior: { valor: '12%', valorNumerico: 12, status: 'alert' },
      valor_credito_financiamento: { valor: 'R$ 42M', valorNumerico: 42, status: 'alert' },
      valor_operacoes_nao_automaticas: { valor: 'R$ 8M', valorNumerico: 8, status: 'alert' },
      negocios_abertos: { valor: '520', valorNumerico: 520, status: 'warning' },
      empresas_ativas: { valor: '8.120', valorNumerico: 8120, status: 'warning' },
      negocios_extintos: { valor: '480', valorNumerico: 480, status: 'alert' },
      bolsa_familia_crescimento: { valor: '+6,5%', valorNumerico: 6.5, status: 'alert' },
      negocios_apoiados_sebrae: { valor: '180', valorNumerico: 180, status: 'alert' },
      compras_publicas_mpe: { valor: '5%', valorNumerico: 5, status: 'alert' },
      linhas_credito: { valor: '4', valorNumerico: 4, status: 'alert' },
    },
  },
  '2501302': {
    nome: 'Bayeux',
