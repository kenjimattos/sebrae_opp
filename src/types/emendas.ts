...
// a rota GET /api/emendas devolve (server/src/emendas/service.ts → buildEmendasData).
// O mesmo contrato está em server/src/types/api.ts — se mexer num, mexa nos dois.
// Nesta branch quem serve esse shape é o snapshot public/api-snapshot/emendas.json.
