  ...
  return (
    <div ref={ref} className={`relative z-[1000] ${className}`}>
      <button
        ...
        className="flex items-center justify-between gap-xs w-full bg-[var(--semantic-surface-secondary)] rounded-[var(--radius-sm)] px-[var(--spacing-sm)] py-[var(--spacing-xs)] typo-body-bold cursor-pointer"
      >
