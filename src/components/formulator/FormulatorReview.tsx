// Tela de revisão/conclusão do Formulador (sem dependência de rota).
...
export default function FormulatorReview({ onEdit, onHome }: FormulatorReviewProps) {
    ...
    <div className="flex items-start gap-sm w-full">
      ...
      <Card padding="lg" radius="sm" className="flex flex-col gap-lg flex-1">
        ...
        <div className="flex items-center gap-sm">
          <Button label="Editar projeto" variant="tertiary" size="md" onClick={onEdit} />
