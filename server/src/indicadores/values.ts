import type { IndicatorDoc, IndicatorValueDoc } from '../types/index.js'

// Regras de "qual valor de indicador vale" — qual ano servir e quando não
// servir nenhum. Ficam aqui, e não dentro de um serviço, porque valem para as
// duas leituras do mesmo dado: a ficha do município (`municipios/service.ts`) e
// a cor do mapa (`mapa/service.ts`). Regra duplicada nos dois daria um mapa
// discordando da ficha que ele abre.
...
export function isLowConfidence(v: IndicatorValueDoc | undefined): boolean {
